...
config_dir = appdirs.user_config_dir('HeroScan')
...
config = {
	'protected_classes': ['HeroScan', 'target', 'service', 'commandstreamreader', 'plugin', 'portscan', 'report', 'servicescan', 'global', 'pattern'],
